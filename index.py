...
players = [
    {
        ...
        'club': 'https://tmssl.akamaized.net/images/wappen/head/1003.png?lm=1472229265'
    },
    {
        'photo': 'https://i2-prod.birminghammail.co.uk/incoming/article18026262.ece/ALTERNATES/s1200c/0_Pierre-Emerick-Aubameyang.jpg',
        'profile': 'https://www.transfermarkt.com/pierre-emerick-aubameyang/leistungsdaten/spieler/58864/plus/0?saison=2018',
        'text': '2018/2019 Season',
        'filter': 'Premier League',
        'club': 'https://tmssl.akamaized.net/images/wappen/head/11.png?lm=1489787850'
    },
    {
    ...
    },
    {
        ...
        'filter': 'Premier League',
        'club': 'https://tmssl.akamaized.net/images/wappen/head/148.png?lm=1544345801'
    },
    {
    ...
    },
    {
        ...
        'filter': 'Premier League',
        'club': 'https://tmssl.akamaized.net/images/wappen/head/985.png?lm=1457975903'
    },
    {
...
for player in players:
    Images.save(player['photo'], player['profile'], player['text'], player['filter'], player['club'], 'lasts-pl-scorers')